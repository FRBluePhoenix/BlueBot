...
module.exports.run = (client, message, args) => {
  if (!args.length) {
    ...
    const embed = new MessageEmbed()
      ...
      .addField("Utilisation", command.help.usage ? `${config.PREFIX}${command.help.name} ${command.help.usage}` : `${config.PREFIX}${command.help.name}`, true)
